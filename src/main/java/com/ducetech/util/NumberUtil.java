...
public class NumberUtil {
    ...
    public static BigDecimal negative(BigDecimal num) {
        return NumberUtil.mul(num, new BigDecimal(-1));
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(NumberUtil.numberFormat("#,##0.0000", new BigDecimal("53232332.3656")));
        System.out.println(NumberUtil.sub(new BigDecimal(6.0), new BigDecimal(5.3)));
        System.out.println(NumberUtil.compare(NumberUtil.sub(new BigDecimal(4900.23), new BigDecimal(4000)), BigDecimal.ZERO));
        /*long lang=1;
